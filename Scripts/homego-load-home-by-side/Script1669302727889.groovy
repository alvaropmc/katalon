...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Alarmas en Espaa - HomeGO de Yoigo/button_Llamadme ahora'), 
    0)

WebUI.verifyTextPresent('¿Necesitas ayuda?', true)
